...
namespace WIMSdatarekeying
{
    ...
    {
        private Lazy<global::WIMSdatarekeying.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::WIMSdatarekeying.WorkflowRunnerService>(() => new global::WIMSdatarekeying.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::WIMSdatarekeying.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
