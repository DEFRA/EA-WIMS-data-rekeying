...
namespace WIMSdatarekeying
{
    public class WorkflowRunnerService
    {
        ...
        /// </summary>
        public string Update_Party_Name_Sheet(object in_strOrgName, object in_strRegion, System.Data.DataTable in_dtPTK)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Process\Process Subflows\Update Party Name Sheet.xaml", new Dictionary<string, object>{{"in_strOrgName", in_strOrgName}, {"in_strRegion", in_strRegion}, {"in_dtPTK", in_dtPTK}}, default, default, default, GetAssemblyName());
        ...
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public string Update_Party_Name_Sheet(object in_strOrgName, object in_strRegion, System.Data.DataTable in_dtPTK, System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Process\Process Subflows\Update Party Name Sheet.xaml", new Dictionary<string, object>{{"in_strOrgName", in_strOrgName}, {"in_strRegion", in_strRegion}, {"in_dtPTK", in_dtPTK}}, default, isolated, default, GetAssemblyName());
            return (string)result["out_strPTK"];
        }
