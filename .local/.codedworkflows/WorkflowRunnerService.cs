...
namespace WIMSdatarekeying
{
    public class WorkflowRunnerService
    {
        ...
        /// </summary>
        public void Process_Transaction(System.Data.DataTable in_dtLookups, System.Data.DataTable in_dtPTK)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Process\Process Transaction.xaml", new Dictionary<string, object>{{"in_dtLookups", in_dtLookups}, {"in_dtPTK", in_dtPTK}}, default, default, default, GetAssemblyName());
        }
        ...
        public void Process_Transaction(System.Data.DataTable in_dtLookups, System.Data.DataTable in_dtPTK, System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Process\Process Transaction.xaml", new Dictionary<string, object>{{"in_dtLookups", in_dtLookups}, {"in_dtPTK", in_dtPTK}}, default, isolated, default, GetAssemblyName());
        }
        ...
        /// <summary>
        /// Invokes the Framework/SetTransactionStatus - EXCEL.xaml
        /// </summary>
        public (int io_intConSysEx, int io_RetryNumber, int io_TransactionNumber) SetTransactionStatus___EXCEL(UiPath.Core.BusinessRuleException in_BusinessException, System.DateTime in_dateCaseStartTime, string in_strWorkLogFilepath, System.Exception in_SystemException, int io_intConSysEx, int io_RetryNumber, int io_TransactionNumber)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Framework\SetTransactionStatus - EXCEL.xaml", new Dictionary<string, object>{{"in_BusinessException", in_BusinessException}, {"in_dateCaseStartTime", in_dateCaseStartTime}, {"in_strWorkLogFilepath", in_strWorkLogFilepath}, {"in_SystemException", in_SystemException}, {"io_intConSysEx", io_intConSysEx}, {"io_RetryNumber", io_RetryNumber}, {"io_TransactionNumber", io_TransactionNumber}}, default, default, default, GetAssemblyName());
        ...
        /// </summary>
        public (bool out_boolLastTransaction, System.Data.DataTable out_dtPTK) GetTransactionData(int in_TransactionNumber, string in_strProcessType, bool in_boolContinue)
        {
        ...
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public (bool out_boolLastTransaction, System.Data.DataTable out_dtPTK) GetTransactionData(int in_TransactionNumber, string in_strProcessType, bool in_boolContinue, System.Boolean isolated)
        {
        ...
        /// </summary>
        public UiPath.Core.UiElement Create_new_release(string in_strName, string in_strDischargeTypes, string in_strGridReference, string in_strTreatmentType, string in_strFlowCode, string in_strDescription, string in_strOrgNames, string in_strDischargeSiteAddress, string in_strOutletDischargeType, string in_strRegulatedActivitySubClass)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Process\Process Subflows\Create new release.xaml", new Dictionary<string, object>{{"in_strName", in_strName}, {"in_strDischargeTypes", in_strDischargeTypes}, {"in_strGridReference", in_strGridReference}, {"in_strTreatmentType", in_strTreatmentType}, {"in_strFlowCode", in_strFlowCode}, {"in_strDescription", in_strDescription}, {"in_strOrgNames", in_strOrgNames}, {"in_strDischargeSiteAddress", in_strDischargeSiteAddress}, {"in_strOutletDischargeType", in_strOutletDischargeType}, {"in_strRegulatedActivitySubClass", in_strRegulatedActivitySubClass}}, default, default, default, GetAssemblyName());
        ...
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public UiPath.Core.UiElement Create_new_release(string in_strName, string in_strDischargeTypes, string in_strGridReference, string in_strTreatmentType, string in_strFlowCode, string in_strDescription, string in_strOrgNames, string in_strDischargeSiteAddress, string in_strOutletDischargeType, string in_strRegulatedActivitySubClass, System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Process\Process Subflows\Create new release.xaml", new Dictionary<string, object>{{"in_strName", in_strName}, {"in_strDischargeTypes", in_strDischargeTypes}, {"in_strGridReference", in_strGridReference}, {"in_strTreatmentType", in_strTreatmentType}, {"in_strFlowCode", in_strFlowCode}, {"in_strDescription", in_strDescription}, {"in_strOrgNames", in_strOrgNames}, {"in_strDischargeSiteAddress", in_strDischargeSiteAddress}, {"in_strOutletDischargeType", in_strOutletDischargeType}, {"in_strRegulatedActivitySubClass", in_strRegulatedActivitySubClass}}, default, isolated, default, GetAssemblyName());
            return (UiPath.Core.UiElement)result["out_uiReleases"];
        }
        ...
        /// <summary>
        /// Invokes the Process/Process Subflows/tc01 Update Party Name List.xaml
        /// </summary>
        public void tc01_Update_Party_Name_List()
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Process\Process Subflows\tc01 Update Party Name List.xaml", new Dictionary<string, object>{}, default, default, default, GetAssemblyName());
        }
        ...
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public void tc01_Update_Party_Name_List(System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Process\Process Subflows\tc01 Update Party Name List.xaml", new Dictionary<string, object>{}, default, isolated, default, GetAssemblyName());
        }
        ...
        /// <summary>
        /// Invokes the Framework/t01 SetTransactionStatus.xaml
        /// </summary>
        public void t01_SetTransactionStatus()
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Framework\t01 SetTransactionStatus.xaml", new Dictionary<string, object>{}, default, default, default, GetAssemblyName());
        }
        ...
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public void t01_SetTransactionStatus(System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Framework\t01 SetTransactionStatus.xaml", new Dictionary<string, object>{}, default, isolated, default, GetAssemblyName());
        }
        ...
        /// </summary>
        public UiPath.Core.UiElement Create_new_outlet(string in_strReference, string in_strGridReference, string in_strEnvironmentCode, string in_strTotalOutlets, string in_strDischargeType, string in_strOrgName, string in_strActivityDescriptions, string in_strRASCs)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Process\Process Subflows\Create new outlet.xaml", new Dictionary<string, object>{{"in_strReference", in_strReference}, {"in_strGridReference", in_strGridReference}, {"in_strEnvironmentCode", in_strEnvironmentCode}, {"in_strTotalOutlets", in_strTotalOutlets}, {"in_strDischargeType", in_strDischargeType}, {"in_strOrgName", in_strOrgName}, {"in_strActivityDescriptions", in_strActivityDescriptions}, {"in_strRASCs", in_strRASCs}}, default, default, default, GetAssemblyName());
        ...
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public UiPath.Core.UiElement Create_new_outlet(string in_strReference, string in_strGridReference, string in_strEnvironmentCode, string in_strTotalOutlets, string in_strDischargeType, string in_strOrgName, string in_strActivityDescriptions, string in_strRASCs, System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Process\Process Subflows\Create new outlet.xaml", new Dictionary<string, object>{{"in_strReference", in_strReference}, {"in_strGridReference", in_strGridReference}, {"in_strEnvironmentCode", in_strEnvironmentCode}, {"in_strTotalOutlets", in_strTotalOutlets}, {"in_strDischargeType", in_strDischargeType}, {"in_strOrgName", in_strOrgName}, {"in_strActivityDescriptions", in_strActivityDescriptions}, {"in_strRASCs", in_strRASCs}}, default, isolated, default, GetAssemblyName());
            return (UiPath.Core.UiElement)result["out_uiOutletRef"];
        }
